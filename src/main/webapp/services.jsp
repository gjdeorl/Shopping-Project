...
<body id="home">
		...
		<div class="container">
			...
			<div class="our-advantages-wrap">
				<div class="our-advantages-item">
					<img src="resources/img/advantages-1.svg" alt="icon">
					<h5>Free shipping <br>from $500</h5>
				</div>
				<div class="our-advantages-item">
					<img src="resources/img/advantages-2.svg" alt="icon">
					<h5>Warranty service <br>for 3 months</h5>
				</div>
				<div class="our-advantages-item">
					<img src="resources/img/advantages-3.svg" alt="icon">
					<h5>Exchange and return <br>within 14 days</h5>
				</div>
				<div class="our-advantages-item">
					<img src="resources/img/advantages-4.svg" alt="icon">
			...
			<div class="row product-cover">
				<div class="col-sm-6 col-lg-3">
					<div class="product-item">
						...
						<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-9.png" alt="product"></a>
				...
				<div class="col-sm-6 col-lg-3">
					<div class="product-item">
						...
						<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-10.png" alt="product"></a>
						<div class="product-item-cover">
							<div class="price-cover">
				...
				<div class="col-sm-6 col-lg-3">
					<div class="product-item">
						...
						<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-11.png" alt="product"></a>
						<div class="product-item-cover">
							<div class="price-cover">
								<div class="new-price">$1.699</div>
								<div class="old-price">$1.799</div>
				...
				<div class="col-sm-6 col-lg-3">
					<div class="product-item">
						...
						<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-12.png" alt="product"></a>
						<div class="product-item-cover">
							<div class="price-cover">
								<div class="new-price">$1.499</div>
								<div class="old-price">$1.799</div>
	...
	<section class="s-contacts">
		<div class="container s-anim">
			...
			<form id='contactform' action="resources/php/contact.php" name="contactform">
				<ul class="form-cover">
