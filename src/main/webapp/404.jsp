...
<body id="home">
					...
					<ul class="nav-list">
						...
						<li class="dropdown">
							...
							<ul>
								...
								<li class="active"><a href="404.jsp">Page error 404</a></li>
							</ul>
						</li>
	...
	<!-- ================= PAGE-ERROR ================= -->
	<section class="page-error" style="background-image: url(resources/img/bg-error.jpg);">
		<div class="container">
			<h1 class="name">Oops!</h1>
			<h3>Error message</h3>
			<p>Don't worry let's go Home</p>
			<a href="index.jsp" class="btn"><span>home</span></a>
		</div>
	</section>
	<!-- =============== PAGE-ERROR END =============== -->
