			...
			<div class="row">
				...
				<div class="col-12 col-lg-9 shop-cover">
					<div class="baner-shop">
						...
						<img src="resources/img/banner-shop.jpg" alt="img">
						<div class="baner-item-content">
							...
							<a href="single-shop.jsp" class="btn"><span>read more</span></a>
						...
						<div class="row product-cover block">
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-5.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-6.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-7.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
							...
							<div class="col-12 col-sm-4 prod-item-col">
								<div class="product-item">
									...
									<a href="single-shop.jsp" class="product-img"><img src="resources/img/prod-8.png" alt="product"></a>
									<div class="product-item-wrap">
										<div class="product-item-cover">
											<div class="price-cover">
												<div class="new-price">$1.699</div>
