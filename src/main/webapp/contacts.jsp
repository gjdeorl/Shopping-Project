		...
		<div class="container">
			<div class="row contact-top-cover">
				<div class="col-12 col-lg-6 contact-img">
					<img src="resources/img/cont-img-1.jpg" alt="img">
				</div>
		...
		<div class="container">
			<div class="row contacts-block">
				<div class="col-12 col-md-4">
					<div class="contact-block-item">
						<div class="contact-block-left">
							<img src="resources/img/cont-icon-1.svg" alt="img">
							<h6>need help</h6>
						</div>
				...
				<div class="col-12 col-md-4">
					<div class="contact-block-item">
						<div class="contact-block-left">
							<img src="resources/img/cont-icon-2.svg" alt="img">
							<h6>questions</h6>
						</div>
						<div class="contact-block-right">
							<ul>
				...
				<div class="col-12 col-md-4">
					<div class="contact-block-item">
						<div class="contact-block-left">
							<img src="resources/img/cont-icon-3.svg" alt="img">
							<h6>address</h6>
						</div>
						<div class="contact-block-right">
							<ul>
